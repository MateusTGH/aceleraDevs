...
public class TurmaController {
    ...
    @PostMapping(value = "/turmaEditar")
    public String editeTurma(TurmaDTO turma) throws TurmaNotFoundException, CursoNotFoundException {

        Turma editeTurma = turmaDTOService.mapTurma(turma);
        turmaService.edite(editeTurma);
        return "redirect:/turma";
    }

    @PostMapping(value = "/turma")
    public String removeTurma(TurmaDTO turma) throws TurmaNotFoundException, CursoNotFoundException {

        Turma removeTurma = turmaDTOService.mapTurma(turma);
        turmaService.remove(removeTurma);
        return "redirect:/turma";
    }
}
